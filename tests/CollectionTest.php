...
class CollectionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $item1 = m::mock('Ecpanda\Util\ArrayableInterface');
        $item1->shouldReceive('toArray')->once()->andReturn('foo.array');
        $item2 = m::mock('Ecpanda\Util\ArrayableInterface');
    ...
    {
        $c = $this->getMockBuilder('Ecpanda\Util\Collection')
                         ->setMethods(['toArray'])
                         ->getMock();
    ...
    public function testChunk()
    {
        ...
        $this->assertInstanceOf('Ecpanda\Util\Collection', $data);
        $this->assertInstanceOf('Ecpanda\Util\Collection', $data[0]);
    ...
    public function testRandom()
    {
        ...
        $this->assertInstanceOf('Ecpanda\Util\Collection', $random);
    ...
    public function testZip()
    {
        ...
        $this->assertInstanceOf('Ecpanda\Util\Collection', $c);
        $this->assertInstanceOf('Ecpanda\Util\Collection', $c[0]);
        $this->assertInstanceOf('Ecpanda\Util\Collection', $c[1]);
        $this->assertInstanceOf('Ecpanda\Util\Collection', $c[2]);
